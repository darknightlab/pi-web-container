...
const servicesDescription =
  paseoValue === "1" ? "It runs [`pi-web`](https://github.com/agegr/pi-web) for browser-based Pi sessions and [`paseo`](https://github.com/getpaseo/paseo) for remote and mobile agent orchestration." : "It runs [`pi-web`](https://github.com/agegr/pi-web) for browser-based Pi sessions.";
...
- Pi Web supports standard Markdown links and images; local filesystem paths are supported as link targets and image sources. If you want to show something to user, use this method.
